...
# ctm2pts2pb2tol
local/ctm2pts.py alignme/lang/phones.txt $RES_DIR/${am_tag}_ali $RES_DIR/${am_tag}_ali
local/pts2pb.py  $BSL_DIR $RES_DIR/${am_tag}_ali M $RES_DIR/${am_tag}_ali/ali_m.pb
local/pts2pb.py  $BSL_DIR $RES_DIR/${am_tag}_ali F $RES_DIR/${am_tag}_ali/ali_f.pb
local/pb2tol.py  $RES_DIR/${am_tag}_ali/ali_{m,f}.pb | tee $RES_DIR/${am_tag}_ali/ali.tol
