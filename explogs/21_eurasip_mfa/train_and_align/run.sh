...
if [ $STAGE -le 1 ] ; then
  mkdir -p $WORKDIR/tg
  echo "[$0] calling train and align script for male dataset" | lolcat
  steps/train_and_align.sh ../../../male   ../../../dict_fb.dict $WORKDIR/tg || exit 1
  echo "[$0] calling train and align script for female dataset" | lolcat
  steps/train_and_align.sh ../../../female ../../../dict_fb.dict $WORKDIR/tg || exit 1
fi
