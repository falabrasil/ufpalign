    ...
    def get_intervalsize(self, itm_id, tokenlist):
        if itm_id == 0:
            ...
            return len(tokenlist['graph']) - \
                       ...
                       0 #tokenlist['phnid'].count(CTM_SIL_ID)  # FIXME why?
        else:
            return 1
